...
import { AlertRequest } from '../interfaces';
...
export class AlertHelper {
  ...
  public static SimpleMessageService(message?: AlertRequest) {
    Swal.fire({
      position: 'center',
      html: `
      ...
      confirmButtonText: message?.confirmButtonText ?? 'Volver al formulario',
  ...
  public static SuccessMessageV2Service(message?: AlertRequest) {
    Swal.fire({
      position: 'center',
      html: `
  ...
  public static ErrorMessageV2Service(message?: AlertRequest) {
    Swal.fire({
      position: 'center',
      html: `
      <div class="mt-6 text-lg">
  ...
  public static ValidateRequest(menssage?: AlertRequest) {
    Swal.fire({
      position: 'center',
      icon: 'warning',
  ...
  public static ErrorService(menssage?: AlertRequest) {
    Swal.fire({
      position: 'center',
      icon: 'error',
  ...
  public static ValidationService(menssage?: AlertRequest) {
    Swal.fire({
      position: 'center',
      icon: 'error',
      title: 'Alerta:',
  ...
  public static SuccessService(menssage: AlertRequest) {
    Swal.fire({
      position: 'center',
      icon: 'success',
  ...
  public static AlertService(menssage: AlertRequest) {
    Swal.fire({
      position: 'center',
      icon: 'warning',
  ...
  public static async ConfirmService(menssage: AlertRequest): Promise<boolean> {
    const result = await Swal.fire({
      position: 'center',
      icon: 'warning',
      title: menssage.title,
